...
class GlobalTestOpenAcademySession(TransactionCase):
    ...
    def test_20_wkf_done(self):
        ...
        # Change next state and ckeck it 
        session_test.signal_workflow('button_confirm')
        self.assertEqual(session_test.state, 'confirmed', "Singal confirm don't work fine!")

        # Change next state and ckeck it
        session_test.signal_workflow('button_done')
        self.assertEqual(session_test.state, 'done', "Singal done don't work fine!")

        # Just to test the data generated by the test.Don't Use.
        # self.env.cr.commit()
